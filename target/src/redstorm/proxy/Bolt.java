...
public class Bolt extends RubyObject implements IRichBolt {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "end\n" +
            "").toString();
        __ruby__.executeScript(source, "/home/fetcher/.rvm/gems/jruby-1.6.7.2/bundler/gems/redstorm-ddff6b65aed9/lib/red_storm/proxy/bolt.rb");
    ...
    public  Bolt(String base_class_path, String real_bolt_class_name) {
        ...
        RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "initialize", ruby_base_class_path, ruby_real_bolt_class_name);
    ...
    public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "prepare", ruby_conf, ruby_context, ruby_collector);
        return;
    ...
    public void execute(Tuple tuple) {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "execute", ruby_tuple);
        return;
