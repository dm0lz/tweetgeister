...
public class Spout extends RubyObject implements IRichSpout {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "end\n" +
            "").toString();
        __ruby__.executeScript(source, "/home/fetcher/.rvm/gems/jruby-1.6.7.2/bundler/gems/redstorm-ddff6b65aed9/lib/red_storm/proxy/spout.rb");
    ...
    public  Spout(String base_class_path, String real_spout_class_name) {
        ...
        RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "initialize", ruby_base_class_path, ruby_real_spout_class_name);
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "open", ruby_conf, ruby_context, ruby_collector);
        return;
    ...
    public void close() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "close");
        return;
    ...
    public void activate() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "activate");
        return;
    ...
    public void deactivate() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "deactivate");
        return;
    ...
    public void nextTuple() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "nextTuple");
        return;
    ...
    public void ack(Object msg_id) {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "ack", ruby_msg_id);
        return;
    ...
    public void fail(Object msg_id) {
        IRubyObject ruby_msg_id = JavaUtil.convertJavaToRuby(__ruby__, msg_id);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "fail", ruby_msg_id);
        return;
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "declareOutputFields", ruby_declarer);
        return;
    ...
    public Map<String, Object> getComponentConfiguration() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "getComponentConfiguration");
